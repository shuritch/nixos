  ...
  theme = {
    "theme/generated.json" = __toJSON {
      ...
      "semanticTokenColors" = {
        ...
        "selfKeyword" = { "foreground" = "#${base08}"; };
        "boolean" = { "foreground" = "#${base09}"; };
        "number" = { "foreground" = "#${base09}"; };
        "variable.defaultLibrary" = { "foreground" = "#${base08}"; };
        "class:python" = { "foreground" = "#${base0A}"; };
        "class.builtin:python" = { "foreground" = "#${base0E}"; };
        "variable.typeHint:python" = { "foreground" = "#${base0A}"; };
        "function.decorator:python" = { "foreground" = "#${base09}"; };
        "variable.readonly:javascript" = { "foreground" = "#${base05}"; };
        "variable.readonly:typescript" = { "foreground" = "#${base05}"; };
        "property.readonly:javascript" = { "foreground" = "#${base05}"; };
        "property.readonly:typescript" = { "foreground" = "#${base05}"; };
        "variable.readonly:javascriptreact" = { "foreground" = "#${base05}"; };
        "variable.readonly:typescriptreact" = { "foreground" = "#${base05}"; };
        "property.readonly:javascriptreact" = { "foreground" = "#${base05}"; };
        "property.readonly:typescriptreact" = { "foreground" = "#${base05}"; };
        "variable.readonly:scala" = { "foreground" = "#${base05}"; };
        "type.defaultLibrary:go" = { "foreground" = "#${base0E}"; };
        ...
        "text.math" = { "foreground" = "#${base06}"; };
        "pol" = { "foreground" = "#${base06}"; };
      };
      "tokenColors" = [
        {
