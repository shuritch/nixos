{ lib, boost, cairo, cmake, fetchurl, fuse, glibmm, gnome, gobject-introspection
, gtk3, intltool, libnotify, libstartup_notification, libwnck3, libxml2, libxslt
, makeWrapper, mesa_glu, pcre2, pkg-config, protobuf, python3Packages, stdenv
, wrapGAppsHook3, xorg, xorgserver, ... }:

stdenv.mkDerivation (f: {
  pname = "compiz";
  version = "0.9.14.2";
  dontWrapGApps = true;
  pythonPath = with python3Packages; [ pycairo pygobject3 ];
  shortVersion =
