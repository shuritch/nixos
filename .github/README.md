...
├─<core>─┼─> users                            # Users configuration (auto-imported)
...
├─<home>─┼─> options                          # Optional configurations (access via host/home.nix)
│        └─> default.nix                      # Loader, imported by hosts/default.nix
│
...
├─<hosts>─┼─> default.nix                     # Loader
│         ╽
│         H
│         O
│         S
│         T  ┌─> configuration.nix            # NixOS Configuration
...
├─<library>─┼─> modules                       # Modules for more accurate customization.
